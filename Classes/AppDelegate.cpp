...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("SurgeryU", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
    ...
    def->getBoolForKey("RETURNVISIT", false); // never start from begin story screen
